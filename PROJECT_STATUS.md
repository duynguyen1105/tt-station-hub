...
| §12.6 | Tank dip → liters conversion (barem bồn)                             | Physical stock entry             | AI now reads the dip photo (HẦM no. / fuel / capacity / raw measurement); **unit confirmed = mm**. The mm→liters barem table + the exact measurement format (e.g. "01....500") are still pending — Trường Thịnh will re-photograph more clearly; conversion deferred, raw value recorded for now. |
