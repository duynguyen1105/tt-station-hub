...
/**
 * Thêm nhiên liệu, and Sửa on a giá bán lẻ row. One component for both because they
 * ask the same two questions — the tên, and whether the nhiên liệu is một giá toàn
 * quốc — and differ only in where they are opened from and what they POST to.
 *
      ...
      {editing ? (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            {/* Xoá and Ngừng sử dụng join it in ticket 03. */}
            <DropdownMenuItem onSelect={() => openChange(true)}>{vi.common.edit}</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      ) : (
