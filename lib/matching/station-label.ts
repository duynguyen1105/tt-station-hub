...
// Reserved holding station on which older photos were parked when no trạm could be
// identified — inactive so it never shows in pickers/overviews; the reviewer
// re-assigns such a visit via the dropdown on the review card. Nothing parks
// there any more: every upload names its trạm.
