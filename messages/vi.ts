...
export const vi = {
  ...
  stations: {
    ...
    code: 'Mã trạm',
    name: 'Tên trạm',
    editInfo: 'Sửa thông tin trạm',
    saved: 'Đã cập nhật trạm.',
    duplicateCode: 'Mã trạm đã được sử dụng.',
    reservedCode: 'Mã trạm này được dành riêng.',
  },
  ...
  shifts: {
    ...
    reopened: 'Đã mở lại ca.',
    reopenTitle: 'Mở lại ca đã chốt?',
    reopenBody:
      'Lượng bán của ca sẽ được hoàn lại vào kho. Sau khi sửa và chốt ca lần nữa, bạn cần xuất lại file MISA.',
  ...
  upload: {
    ...
    shiftClosed: 'Ca này đã chốt — quản trị viên cần Mở lại ca trước khi tải ảnh chốt ca.',
  },
  ...
  correction: {
    ...
    adminOnly: 'Chỉ admin',
    closingLocked: 'Ca đã chốt — quản trị viên cần Mở lại ca',
    decisionLocked: 'Đã duyệt/từ chối — chỉ quản trị viên được sửa',
  ...
  inventory: {
    ...
    manualMovements: 'Phát sinh nhập tay',
    movementSaved: 'Đã cập nhật phát sinh kho.',
    movementDeleted: 'Đã xóa phát sinh kho.',
    movementConfirmDelete: 'Xóa phát sinh nhập tay này? Tồn kho sẽ được cập nhật.',
    manualOnly: 'Chỉ được sửa hoặc xóa phát sinh nhập tay.',
    quantity: 'Số lượng (lít)',
    note: 'Ghi chú',
  ...
  imports: {
    ...
    truckPlate: 'Xe bồn',
    note: 'Ghi chú',
    editAction: 'Sửa phiếu',
    editSaved: 'Đã sửa phiếu nhập',
    editCancelled: 'Phiếu có hầm đã hủy — không thể sửa biên bản.',
    editChanged: 'Phiếu đã thay đổi — tải lại trang rồi thử lại.',
    baremBeforeLiters: 'SL barem trước nhập (lít)',
    measuredNeedsBefore: 'Nhập SL barem trước nhập để sửa số lít thực tế.',
  ...
  documents: {
    ...
    scan: 'File scan',
    view: 'Xem',
    missingName: 'Vui lòng nhập tên giấy tờ.',
    ...
    notes: 'Ghi chú',
    saved: 'Đã cập nhật giấy tờ.',
    deleted: 'Đã xóa giấy tờ.',
    confirmDelete: 'Xóa giấy tờ này và bản scan đính kèm?',
  },
  ...
  debtReview: {
    ...
    chargeMissing:
      'Khoản ghi nợ của lượt xe không khớp trạng thái hiện tại. Kiểm tra sổ trước khi thử lại.',
    alreadyRejected: 'Lượt xe này đã bị từ chối.',
    ...
    amountManualToggle: 'Nhập thành tiền bằng tay',
    amountComputed: 'Tự tính',
    amountManualHint: 'Chỉ nhập khi số tiền thực thu khác số tự tính (lít × đơn giá).',
    amountManualInvalid: 'Thành tiền phải là số nguyên dương (đồng).',
    amountManualTooLarge: 'Thành tiền vượt quá mức hợp lý.',
    amountManualNeedsLiters: 'Nhập số lít trước khi sửa thành tiền.',
    needAmount: 'Chưa có thành tiền để ghi nợ.',
    aiRead: 'AI đọc',
    alreadyApproved: 'Lượt xe này đã được duyệt.',
    confidence: 'Tin cậy',
    rejectApprovedBody: 'Khoản ghi nợ của lượt xe này sẽ được xóa khỏi sổ công nợ.',
